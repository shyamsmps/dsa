...
/**
 * Given an integer x, return true if x is algo.examples.Palindrome integer.
 * An integer is a algo.examples.Palindrome when it reads the same backward as forward.
 * Input: x = -121
 * Output: false
 * Explanation: From left to right, it reads -121. From right to left, it becomes 121-. Therefore it is not a algo.examples.Palindrome.
 */
public class Palindrome {
    ...
    /**
     * First of all we should take care of some edge cases. All negative numbers are not algo.examples.Palindrome, for example: -123 is not a algo.examples.Palindrome since the '-' does not equal to '3'.
